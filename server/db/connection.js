...
function initializeDB() {
  ...
  var requestTable = 'CREATE TABLE IF NOT EXISTS requests (id SERIAL PRIMARY KEY, start VARCHAR(50) NOT NULL, stop VARCHAR(50) NOT NULL, requestor_id INTEGER NOT NULL REFERENCES users (id), caregiver_id INTEGER NOT NULL REFERENCES users (id), comments VARCHAR(120), completed BOOLEAN DEFAULT false);';
